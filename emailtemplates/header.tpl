<div style="margin-top: 50px;">
    <table style="font-family: Nunito, sans-serif; font-size: 15px; font-weight: 400; max-width: 600px; border: none; margin: 0px auto; border-radius: 6px; overflow: hidden; background: #f2eeee; box-shadow: rgba(60, 72, 88, 0.15) 0px 0px 3px; height: 92px; width: 473px;" cellspacing="0" cellpadding="0">
      <tbody>
